...
import com.example.asus_desktop.remaskortu.HistoriTugas.MainActivityHistori;
...
public class DaftarAnakAdapter extends RecyclerView.Adapter<DaftarAnakAdapter.MahasiswaViewHolder> {
    ...
    public DaftarAnakAdapter(Context mContext,ArrayList<Result> results) {
    ...
    private void showPopupMenu(View view) {
        ...
        inflater.inflate(R.menu.activity_lihat_anak, popup.getMenu());
    ...
    private class MyMenuItemClickListener implements PopupMenu.OnMenuItemClickListener {
        ...
        public boolean onMenuItemClick(MenuItem menuItem) {
            switch (menuItem.getItemId()) {
                case R.id.action_lihat_anak:
                    Intent intent = new Intent(mContext, MainActivityHistori.class);
